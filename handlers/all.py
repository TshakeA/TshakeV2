...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/rnnni")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/ggi55")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/rnnni")]])
